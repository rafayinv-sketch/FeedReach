...
import Company1 from "../assets/Pictures/Company1.png";
import Company2 from "../assets/Pictures/Company2.png";
import Company3 from "../assets/Pictures/Company3.png";
import Company4 from "../assets/Pictures/Company4.png";
import Company5 from "../assets/Pictures/Company5.png";
import Company6 from "../assets/Pictures/Company6.png";
import Company7 from "../assets/Pictures/Company7.png";
    ...
    <div className="Section2 d-block justify-content-center align-items-center">
      ...
      <div className="div2 d-flex flex-column justify-content-center align-items-center">
        <div className="div2-1 d-flex justify-content-center align-items-center mt-4">
          ...
          >
            Join thousands of teams already streamlining their workflows with
            Projecty.
          </p>
        </div>
